...
app.whenReady().then(() => {
  ...
  ipcMain.on('restart-and-update', () => {
    ...
    // Este método cierra Electron y lanza el instalador NSIS descargado.
    // No se debe cerrar la ventana manualmente antes: electron-updater
    // necesita controlar el ciclo de salida para ejecutar el instalador.
